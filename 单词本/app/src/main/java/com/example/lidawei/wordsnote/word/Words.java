package com.example.lidawei.wordsnote.word;
...
public class Words {
    ...
    //授权者名字，用来确定系统中哪个ContentProvier提供资源
    public static final String AUTHORITY = "com.example.lidawei.wordsprovider";//URI授权者
    ...
    public static abstract class Word implements BaseColumns {
        ...
        public static final String MINE_ITEM = "vnd.example.lidawei.word";

        public static final String MINE_TYPE_SINGLE = MIME_ITEM_PREFIX + "/" + MINE_ITEM;
        public static final String MINE_TYPE_MULTIPLE = MIME_DIR_PREFIX + "/" + MINE_ITEM;

        //数据路径，用来确定请求的数据集。如果ContentProvider提供的数据集唯一，则data_path可以省略
